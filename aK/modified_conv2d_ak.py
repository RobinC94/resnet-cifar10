...
class ModifiedConv2DaK(Layer):
    ...
    def __init__(self,
        ...
        super(ModifiedConv2DaK, self).__init__(**kwargs)
        self.rank =2
    ...
    def build(self, input_shape):
        ...
        self.template =self.add_weight(shape=self.kernel_shape,
                                      initializer=self.kernel_initializer,
                                      name='template',
                                      trainable=False)
    ...
    def call(self,inputs,**kwargs):
        self.kernel = self.A * self.template
    ...
    def get_config(self):
        ...
        base_config =super(ModifiedConv2DaK, self).get_config()
...
if __name__ == "__main__":
    ...
    layer1 =ModifiedConv2DaK(filters=64,
                          kernel_size=(3 ,3),
                          strides=(1 ,1),
